...
class Trainer:
    ...
    def __init__(self,
        ...
        elif not os.path.exists("./checkpoints/weights") or not os.path.exists("./checkpoints/test_images"):
    ...
    def fit(self,
        ...
        with mlflow.start_run(run_name=self.mlf["run_name"]) as _:
            ...
            for epoch in tqdm.tqdm(range(epochs)):
                ...
                if epoch == 1:
                    mlflow.log_artifact("./plot_extract/actors/generate_plots.py")
                    mlflow.log_artifact("./plot_extract/models_zoo/unet.py")
                if (epoch + 1) % 20 == 0:
